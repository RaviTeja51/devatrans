...
class DevaTrans:
    ...
    def __find_character_pos(self, sentence, from_conven):
        ...
        while index < sen_length:
            ...
            final_pos = 1
            char_found = False
            while final_pos <= 5 and (index + final_pos) <= sen_length:
...
if __name__ == '__main__':
    ...
    d = c.back_transliterate("sen", argv[1], sentence="nArAyaNaM")
    #print("HK: ",c.transliterate("sen","hk",sentence = "द्वैपायनेन"))
    print(d)
